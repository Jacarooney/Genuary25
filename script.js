...
let bgCols = ['light', 'light', 'dark', 'dark', 'dark', 'light', 'light', 'light'
];

let titleCols = ['black', 'black', 'white', 'white', 'white', 'black', 'black', 'black'];

let titles = ["Castle Ruins", "Larry Layers", "Twenty-One Helices", "Untitled (Black, Black, Bl...)", "Undecidable Figures", "Fridge Fodder", "Piano Roll Printer", "Porpoise Portraits"];
